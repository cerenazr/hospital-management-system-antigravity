...
output_path = os.path.join(output_dir, 'final_zoom_enhanced_cypress_demo_40s_smooth.mp4')
...
# Stop after 40 seconds (max_frames)
max_frames = int(fps * 40)
...
cap.release()
out.release()
print(f"Final 40‑second smooth video saved to {output_path}")
