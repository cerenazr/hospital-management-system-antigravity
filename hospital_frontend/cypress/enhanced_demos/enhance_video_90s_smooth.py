...
output_path = os.path.join(output_dir, 'final_zoom_enhanced_cypress_demo_90s_smooth.mp4')
...
# Stop after 90 seconds (max_frames)
max_frames = int(fps * 90)
...
cap.release()
out.release()
print(f"Final 90‑second smooth video saved to {output_path}")
